...
def retrieval_tool(query, long_db, short_db):
    ...
    long_results = long_db.smart_query(query, topk=25, top_l=5, use_late=True, doc_search=True)
    short_results = short_db.smart_query(query, topk=25, top_l=5, use_late=True, doc_search=True)
