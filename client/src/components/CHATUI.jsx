...
const getStyles = (theme) => {
  ...
  return {
    ...
    container: {
      ...
      display: 'flex',
      flexDirection: 'column',
      height: isMobile ? '100vh' : isTablet ? 'calc(100vh - 20px)' : 'calc(100vh - 40px)',
    ...
    header: {
      ...
      padding: isMobile ? '16px' : isTablet ? '14px' : '12px 24px',
    ...
    adminButton: {
      ...
      borderRadius: 8,
      padding: isMobile ? '4px 12px' : isTablet ? '6px 14px' : '6px 16px',
      fontWeight: 600,
      cursor: 'pointer',
    ...
    chatArea: {
      flex: 1,
      padding: isMobile ? '20px 6px' : isTablet ? '20px 12px' : '20px 16px',
      overflowY: 'auto',
    ...
    message: {
      maxWidth: '100%',
      padding: isPortraitMobile ? '6px 10px' : isMobile ? '8px 12px' : isTablet ? '9px 14px' : '10px 16px',
      borderRadius: 16,
    ...
    reasoningBox: {
      ...
      padding: isMobile ? '10px 14px' : isTablet ? '12px 16px' : '12px 18px',
      borderRadius: 12,
      fontSize: isMobile ? 12 : isTablet ? 13 : 14,
    ...
    inputArea: {
      display: 'flex',
      alignItems: 'center',
      padding: isMobile ? '8px' : isTablet ? '10px' : '12px 20px',
    ...
    disclaimer: {
      width: '100%',
      maxWidth: isMobile ? '95%' : isTablet ? '90%' : '85%',
      textAlign: 'center',
      marginTop: 16,
      fontWeight: 500,
      fontSize: isMobile ? 12 : isTablet ? 13 : 14,
