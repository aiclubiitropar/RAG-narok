...
const getStyles = (theme) => {
  ...
  return {
    page: {
      ...
      paddingTop: isPortraitMobile ? '5px' : isMobile ? '10px' : '20px',
      paddingBottom: isPortraitMobile ? '5px' : isMobile ? '10px' : '20px',
      overflow: 'hidden',
    ...
    container: {
      width: isPortraitMobile ? '100vw' : isMobile ? '95vw' : isTablet ? '90vw' : '80vw',
      maxWidth: 1200,
      margin: '0 auto',
      borderRadius: isPortraitMobile ? 0 : isMobile ? 8 : 16,
      boxShadow: isPortraitMobile ? 'none' : isMobile ? 'none' : '0 8px 30px rgba(0,0,0,0.1)',
      background: currentTheme.containerBg,
      overflow: 'hidden',
      display: 'flex',
      flexDirection: 'column',
      height: isPortraitMobile ? '100vh' : isMobile ? '100vh' : 'calc(100vh - 40px)',
    ...
    header: {
      ...
      padding: isPortraitMobile ? '6px' : isMobile ? '8px' : '12px 24px',
    ...
    chatArea: {
      flex: 1,
      padding: isPortraitMobile ? '4px 3px' : isMobile ? '8px 6px' : '16px',
      overflowY: 'auto',
      background: currentTheme.chatAreaBg,
      display: 'flex',
      flexDirection: 'column',
      gap: isPortraitMobile ? '6px' : isMobile ? '8px' : '12px',
      transition: 'background 0.3s ease-in-out',
    },
    message: {
    ...
    inputArea: {
      display: 'flex',
      alignItems: 'center',
      padding: isPortraitMobile ? '6px' : isMobile ? '8px' : '12px 20px',
      borderTop: `1px solid ${currentTheme.borderColor}`,
      background: currentTheme.inputAreaBg,
      gap: isPortraitMobile ? 4 : isMobile ? 6 : 10,
      flexShrink: 0,
      transition: 'background 0.3s ease-in-out, border 0.3s ease-in-out',
    },
    input: {
      ...
      border: 'none',
      borderRadius: 10,
      padding: isPortraitMobile ? '8px 10px' : isMobile ? '10px 12px' : '12px 16px',
      fontSize: isPortraitMobile ? 12 : isMobile ? 14 : 16,
      outline: 'none',
    ...
    sendButton: {
      ...
      width: isPortraitMobile ? '36px' : isMobile ? '40px' : '48px',
      height: isPortraitMobile ? '36px' : isMobile ? '40px' : '48px',
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
      fontWeight: 700,
    ...
    disclaimer: {
      ...
      marginTop: 16,
      fontWeight: 500,
      fontSize: isPortraitMobile ? 10 : isMobile ? 12 : 14,
