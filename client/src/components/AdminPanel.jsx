...
export default function AdminPanel() {
  ...
  const handleLogin = async () => {
    try {
      const response = await fetch('https://iotacluster-ragnarok-stable.hf.space/admin/verify_credentials', {
        method: 'POST',
        headers: {
  ...
  const fetchWorkerStatus = async () => {
    try {
      const res = await fetch('https://iotacluster-ragnarok-stable.hf.space/admin/worker_status', {
        method: 'GET',
        headers: {
  ...
  const startWorker = async () => {
    try {
      const res = await fetch('https://iotacluster-ragnarok-stable.hf.space/admin/start_shortterm_worker', {
        method: 'POST',
      });
      const data = await res.json();
      ...
      const intervalId = setInterval(async () => {
        const statusRes = await fetch('https://iotacluster-ragnarok-stable.hf.space/admin/worker_status');
  ...
  const stopWorker = async () => {
    try {
      const res = await fetch('https://iotacluster-ragnarok-stable.hf.space/admin/stop_shortterm_worker', {
        method: 'POST',
      });
      const data = await res.json();
  ...
  const downloadLogs = async () => {
    try {
      const res = await fetch('https://iotacluster-ragnarok-stable.hf.space/admin/logs');
      if (res.status === 404) {
  ...
  const uploadJson = async (e) => {
    ...
    try {
      const res = await fetch('https://iotacluster-ragnarok-stable.hf.space/admin/upload_json', {
        method: 'POST',
        body: formData,
      });
      const data = await res.json();
  ...
  const handleChangeModel = async () => {
    try {
      const res = await fetch('https://iotacluster-ragnarok-stable.hf.space/admin/change_model', {
        method: 'POST',
